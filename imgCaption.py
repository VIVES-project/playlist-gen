...
def generate_caption(image: np.ndarray, format:str, weather_desc:str) -> ImageCaption:
    ...
    Answer in JSON with the following format (omit markdown annotations like ```json, only output valid json): {'description': '...', 'top_music_genres': ['genre1', 'genre2', '...'], 'title_playlist':'The playlist name'}'.
    """
    detail = "low"
    max_tokens = 300
